...
class GrafikPendapatanPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # JUDUL
        # ===============================
        ttk.Label(self, text="📊 Grafik Pendapatan", style="Title.TLabel").pack(pady=(20, 10))

        # ===============================
        # FILTER FRAME (BULAN & TAHUN)
        # ===============================
    ...
    def tampilkan_grafik(self):
        ...
        try:
            ...
            # ===============================
            # QUERY DATA PENJUALAN PER TANGGAL
            # ===============================
            c.execute("""
            ...
            if not data:
                self.ax.axis('off')
                self.ax.text(0.5, 0.5, f"Tidak ada data penjualan untuk {bulan} {tahun}.",
