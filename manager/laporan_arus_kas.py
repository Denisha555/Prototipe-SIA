...
class LaporanArusKasPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.treeview = ttk.Treeview(self, columns=("keterangan", "nominal", 'subtotal'), show="headings", height=28)
        ...
        ttk.Button(self, text="Kembali ke Menu Utama", command=lambda: controller.show_frame("Menu Utama Manager")).grid(row=6, column=0, columnspan=2, pady=(5,20))
